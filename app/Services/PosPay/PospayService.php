...
class PospayService
{
    ...
    // public function processInquiry(object $request)
    // {
    //     $va = (string) $request->BillKey1;
    //     $santri = VirtualAccount::join('santri as s', 'virtual_accounts.santri_id', 's.id')
    //         ->join('biodata as b', 's.biodata_id', 'b.id')
...
//     private function responseSuccess(object $request, float $nominal): array
//     {
//         return [
//             'success' => true,
//             'data' => [
...
//     private function responseError(object $request, string $code, string $message): array
//     {
//         return [
//             'success' => false,
//             'data' => [
...
//     // {
//     //     $tagihan = TagihanSantri::where()
//     // }

//     public function payment($request)
//     {
//         $nis = (string) $request->Billkey1;
//         $nominal = number_format((float) $request->PaymentAmount, 2, '.', '');
//         $santriID = Santri::where('nis', $nis)->value('id');
...
//             'tipe'           => 'topup',
//             'jumlah'         => $nominal,
//             'keterangan'     => "Topup saldo melalui Pospay sebesar Rp{$nominal}"
//         ]);
...
//     // public function payment($request)
//     // {
//     //     $billkey = (string) $request->BillKey1;

//     //     // Pola: 10 digit (nis) + digit opsional (tagihan_id) + 2 digit (bulan) + 4 digit (tahun)
//     //     if (preg_match('/^(\d{10})(\d+)(\d{2})(\d{4})$/', $billkey, $matches)) {
//     //         $nis        = $matches[1];
//     //         $tagihanID  = $matches[2];
//     //         $bulan      = $matches[3]; 
//     //         $tahun      = $matches[4]; 
//     //     } else {
//     //         $nis = $tagihanID = $bulan = $tahun = null;
//     //     }
