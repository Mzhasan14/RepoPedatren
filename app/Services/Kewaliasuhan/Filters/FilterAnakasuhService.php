...
class FilterAnakasuhService
{
    /**
     * Panggil semua filter berurutan
     */
    public function AnakasuhFilters(Builder $query, Request $request): Builder
    {
    ...
    {
        // Jika tidak ada parameter sort_by, kembalikan query tanpa perubahan
        ...
        if (in_array($by, $allowed, true)) {
            ...
            // Tambahkan prefix tabel jika kolom ambigu
            switch ($by) {
                case 'jenis_kelamin':
                    $column = 'b.jenis_kelamin';
                    break;
                case 'id':
                    $column = 'biodata.id';
                    break;
            ...
            // Jika kolom tidak diperbolehkan, hentikan query
            $query->whereRaw('0 = 1');
        }
