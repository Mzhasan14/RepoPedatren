...
{
    public function baseNonDomisiliQuery(Request $request)
    {
        // Subquery
    ...
    public function getAllNonDomisili(Request $request, $fields = null)
    {
        $query = $this->baseNonDomisiliQuery($request);

        // Default SELECT untuk list
        $fields = $fields ?? [
            'b.id as biodata_id',
            's.id',
            's.nis',
    ...
    public function getExportNonDomisiliQuery($fields, $request)
    {
        $query = $this->baseNonDomisiliQuery($request);
